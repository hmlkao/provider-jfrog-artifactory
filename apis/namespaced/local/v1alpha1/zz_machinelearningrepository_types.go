...
type MachinelearningRepositoryInitParameters struct {
	...
	// separated list of artifact patterns to exclude when evaluating artifact requests, in the form of x/y/**/z/*. This is a single string of comma-separated values, not a list of strings. By default no artifacts are excluded.
	...
	// separated list of artifact patterns to include when evaluating artifact requests in the form of x/y/**/z/*. This is a single string of comma-separated values, not a list of strings. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included (**/*).
...
type MachinelearningRepositoryObservation struct {
...
type MachinelearningRepositoryParameters struct {
...
type MachinelearningRepositorySpec struct {
	...
	// autoscaler.
	InitProvider MachinelearningRepositoryInitParameters `json:"initProvider,omitempty"`
}

// MachinelearningRepositoryStatus defines the observed state of MachinelearningRepository.
type MachinelearningRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MachinelearningRepositoryObservation `json:"atProvider,omitempty"`
}
...
// MachinelearningRepository is the Schema for the MachinelearningRepositorys API. Provides a resource to creates a Machine Learning repository.
...
type MachinelearningRepository struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              MachinelearningRepositorySpec   `json:"spec"`
	Status            MachinelearningRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// MachinelearningRepositoryList contains a list of MachinelearningRepositorys
type MachinelearningRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MachinelearningRepository `json:"items"`
}

// Repository type metadata.
var (
	MachinelearningRepository_Kind             = "MachinelearningRepository"
	MachinelearningRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MachinelearningRepository_Kind}.String()
	MachinelearningRepository_KindAPIVersion   = MachinelearningRepository_Kind + "." + CRDGroupVersion.String()
	MachinelearningRepository_GroupVersionKind = CRDGroupVersion.WithKind(MachinelearningRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&MachinelearningRepository{}, &MachinelearningRepositoryList{})
}
