...
type RemoteP2RepositoryContentSynchronisationInitParameters struct {
...
type RemoteP2RepositoryContentSynchronisationObservation struct {
...
type RemoteP2RepositoryContentSynchronisationParameters struct {
...
type RemoteP2RepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteP2RepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteP2RepositoryObservation struct {
	...
	ContentSynchronisation []RemoteP2RepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteP2RepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteP2RepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteP2RepositorySpec defines the desired state of RemoteP2Repository
type RemoteP2RepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteP2RepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteP2RepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteP2RepositoryStatus defines the observed state of RemoteP2Repository.
type RemoteP2RepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteP2RepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteP2Repository is the Schema for the RemoteP2Repositorys API. <no value>
...
type RemoteP2Repository struct {
	...
	Spec   RemoteP2RepositorySpec   `json:"spec"`
	Status RemoteP2RepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteP2RepositoryList contains a list of RemoteP2Repositorys
type RemoteP2RepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteP2Repository `json:"items"`
}

// Repository type metadata.
var (
	RemoteP2Repository_Kind             = "RemoteP2Repository"
	RemoteP2Repository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteP2Repository_Kind}.String()
	RemoteP2Repository_KindAPIVersion   = RemoteP2Repository_Kind + "." + CRDGroupVersion.String()
	RemoteP2Repository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteP2Repository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteP2Repository{}, &RemoteP2RepositoryList{})
}
