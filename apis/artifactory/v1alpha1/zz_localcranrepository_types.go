...
type LocalCranRepositoryInitParameters struct {
...
type LocalCranRepositoryObservation struct {
...
type LocalCranRepositoryParameters struct {
...
// LocalCranRepositorySpec defines the desired state of LocalCranRepository
type LocalCranRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalCranRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalCranRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalCranRepositoryStatus defines the observed state of LocalCranRepository.
type LocalCranRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalCranRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalCranRepository is the Schema for the LocalCranRepositorys API. <no value>
...
type LocalCranRepository struct {
	...
	Spec              LocalCranRepositorySpec   `json:"spec"`
	Status            LocalCranRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalCranRepositoryList contains a list of LocalCranRepositorys
type LocalCranRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalCranRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalCranRepository_Kind             = "LocalCranRepository"
	LocalCranRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalCranRepository_Kind}.String()
	LocalCranRepository_KindAPIVersion   = LocalCranRepository_Kind + "." + CRDGroupVersion.String()
	LocalCranRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalCranRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalCranRepository{}, &LocalCranRepositoryList{})
}
