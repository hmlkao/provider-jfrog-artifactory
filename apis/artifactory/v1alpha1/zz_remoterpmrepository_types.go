...
type RemoteRPMRepositoryContentSynchronisationInitParameters struct {
...
type RemoteRPMRepositoryContentSynchronisationObservation struct {
...
type RemoteRPMRepositoryContentSynchronisationParameters struct {
...
type RemoteRPMRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteRPMRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteRPMRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteRPMRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteRPMRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteRPMRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteRPMRepositorySpec defines the desired state of RemoteRPMRepository
type RemoteRPMRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteRPMRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteRPMRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteRPMRepositoryStatus defines the observed state of RemoteRPMRepository.
type RemoteRPMRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteRPMRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteRPMRepository is the Schema for the RemoteRPMRepositorys API. <no value>
...
type RemoteRPMRepository struct {
	...
	Spec   RemoteRPMRepositorySpec   `json:"spec"`
	Status RemoteRPMRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteRPMRepositoryList contains a list of RemoteRPMRepositorys
type RemoteRPMRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteRPMRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteRPMRepository_Kind             = "RemoteRPMRepository"
	RemoteRPMRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteRPMRepository_Kind}.String()
	RemoteRPMRepository_KindAPIVersion   = RemoteRPMRepository_Kind + "." + CRDGroupVersion.String()
	RemoteRPMRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteRPMRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteRPMRepository{}, &RemoteRPMRepositoryList{})
}
