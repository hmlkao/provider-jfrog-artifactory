...
type VirtualAlpineRepositoryInitParameters struct {
...
type VirtualAlpineRepositoryObservation struct {
...
type VirtualAlpineRepositoryParameters struct {
...
// VirtualAlpineRepositorySpec defines the desired state of VirtualAlpineRepository
type VirtualAlpineRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualAlpineRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualAlpineRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualAlpineRepositoryStatus defines the observed state of VirtualAlpineRepository.
type VirtualAlpineRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualAlpineRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualAlpineRepository is the Schema for the VirtualAlpineRepositorys API. <no value>
...
type VirtualAlpineRepository struct {
	...
	Spec              VirtualAlpineRepositorySpec   `json:"spec"`
	Status            VirtualAlpineRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualAlpineRepositoryList contains a list of VirtualAlpineRepositorys
type VirtualAlpineRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualAlpineRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualAlpineRepository_Kind             = "VirtualAlpineRepository"
	VirtualAlpineRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualAlpineRepository_Kind}.String()
	VirtualAlpineRepository_KindAPIVersion   = VirtualAlpineRepository_Kind + "." + CRDGroupVersion.String()
	VirtualAlpineRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualAlpineRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualAlpineRepository{}, &VirtualAlpineRepositoryList{})
}
