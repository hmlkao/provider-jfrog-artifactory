...
type RemoteGemsRepositoryContentSynchronisationInitParameters struct {
...
type RemoteGemsRepositoryContentSynchronisationObservation struct {
...
type RemoteGemsRepositoryContentSynchronisationParameters struct {
...
type RemoteGemsRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteGemsRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteGemsRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteGemsRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteGemsRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteGemsRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteGemsRepositorySpec defines the desired state of RemoteGemsRepository
type RemoteGemsRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteGemsRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteGemsRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteGemsRepositoryStatus defines the observed state of RemoteGemsRepository.
type RemoteGemsRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteGemsRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteGemsRepository is the Schema for the RemoteGemsRepositorys API. <no value>
...
type RemoteGemsRepository struct {
	...
	Spec   RemoteGemsRepositorySpec   `json:"spec"`
	Status RemoteGemsRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteGemsRepositoryList contains a list of RemoteGemsRepositorys
type RemoteGemsRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteGemsRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteGemsRepository_Kind             = "RemoteGemsRepository"
	RemoteGemsRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteGemsRepository_Kind}.String()
	RemoteGemsRepository_KindAPIVersion   = RemoteGemsRepository_Kind + "." + CRDGroupVersion.String()
	RemoteGemsRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteGemsRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteGemsRepository{}, &RemoteGemsRepositoryList{})
}
