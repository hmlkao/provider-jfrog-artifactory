...
type VirtualGemsRepositoryInitParameters struct {
...
type VirtualGemsRepositoryObservation struct {
...
type VirtualGemsRepositoryParameters struct {
...
// VirtualGemsRepositorySpec defines the desired state of VirtualGemsRepository
type VirtualGemsRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualGemsRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualGemsRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualGemsRepositoryStatus defines the observed state of VirtualGemsRepository.
type VirtualGemsRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualGemsRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualGemsRepository is the Schema for the VirtualGemsRepositorys API. <no value>
...
type VirtualGemsRepository struct {
	...
	Spec              VirtualGemsRepositorySpec   `json:"spec"`
	Status            VirtualGemsRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualGemsRepositoryList contains a list of VirtualGemsRepositorys
type VirtualGemsRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualGemsRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualGemsRepository_Kind             = "VirtualGemsRepository"
	VirtualGemsRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualGemsRepository_Kind}.String()
	VirtualGemsRepository_KindAPIVersion   = VirtualGemsRepository_Kind + "." + CRDGroupVersion.String()
	VirtualGemsRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualGemsRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualGemsRepository{}, &VirtualGemsRepositoryList{})
}
