...
type RemoteGoRepositoryContentSynchronisationInitParameters struct {
...
type RemoteGoRepositoryContentSynchronisationObservation struct {
...
type RemoteGoRepositoryContentSynchronisationParameters struct {
...
type RemoteGoRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteGoRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteGoRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteGoRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteGoRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteGoRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteGoRepositorySpec defines the desired state of RemoteGoRepository
type RemoteGoRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteGoRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteGoRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteGoRepositoryStatus defines the observed state of RemoteGoRepository.
type RemoteGoRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteGoRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteGoRepository is the Schema for the RemoteGoRepositorys API. <no value>
...
type RemoteGoRepository struct {
	...
	Spec   RemoteGoRepositorySpec   `json:"spec"`
	Status RemoteGoRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteGoRepositoryList contains a list of RemoteGoRepositorys
type RemoteGoRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteGoRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteGoRepository_Kind             = "RemoteGoRepository"
	RemoteGoRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteGoRepository_Kind}.String()
	RemoteGoRepository_KindAPIVersion   = RemoteGoRepository_Kind + "." + CRDGroupVersion.String()
	RemoteGoRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteGoRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteGoRepository{}, &RemoteGoRepositoryList{})
}
