...
type LocalDockerV2RepositoryInitParameters struct {
...
type LocalDockerV2RepositoryObservation struct {
...
type LocalDockerV2RepositoryParameters struct {
...
// LocalDockerV2RepositorySpec defines the desired state of LocalDockerV2Repository
type LocalDockerV2RepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalDockerV2RepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalDockerV2RepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalDockerV2RepositoryStatus defines the observed state of LocalDockerV2Repository.
type LocalDockerV2RepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalDockerV2RepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalDockerV2Repository is the Schema for the LocalDockerV2Repositorys API. <no value>
...
type LocalDockerV2Repository struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              LocalDockerV2RepositorySpec   `json:"spec"`
	Status            LocalDockerV2RepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalDockerV2RepositoryList contains a list of LocalDockerV2Repositorys
type LocalDockerV2RepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalDockerV2Repository `json:"items"`
}

// Repository type metadata.
var (
	LocalDockerV2Repository_Kind             = "LocalDockerV2Repository"
	LocalDockerV2Repository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalDockerV2Repository_Kind}.String()
	LocalDockerV2Repository_KindAPIVersion   = LocalDockerV2Repository_Kind + "." + CRDGroupVersion.String()
	LocalDockerV2Repository_GroupVersionKind = CRDGroupVersion.WithKind(LocalDockerV2Repository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalDockerV2Repository{}, &LocalDockerV2RepositoryList{})
}
