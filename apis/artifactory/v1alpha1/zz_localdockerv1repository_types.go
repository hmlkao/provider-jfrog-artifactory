...
type LocalDockerV1RepositoryInitParameters struct {
...
type LocalDockerV1RepositoryObservation struct {
...
type LocalDockerV1RepositoryParameters struct {
...
// LocalDockerV1RepositorySpec defines the desired state of LocalDockerV1Repository
type LocalDockerV1RepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalDockerV1RepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalDockerV1RepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalDockerV1RepositoryStatus defines the observed state of LocalDockerV1Repository.
type LocalDockerV1RepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalDockerV1RepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalDockerV1Repository is the Schema for the LocalDockerV1Repositorys API. <no value>
...
type LocalDockerV1Repository struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              LocalDockerV1RepositorySpec   `json:"spec"`
	Status            LocalDockerV1RepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalDockerV1RepositoryList contains a list of LocalDockerV1Repositorys
type LocalDockerV1RepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalDockerV1Repository `json:"items"`
}

// Repository type metadata.
var (
	LocalDockerV1Repository_Kind             = "LocalDockerV1Repository"
	LocalDockerV1Repository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalDockerV1Repository_Kind}.String()
	LocalDockerV1Repository_KindAPIVersion   = LocalDockerV1Repository_Kind + "." + CRDGroupVersion.String()
	LocalDockerV1Repository_GroupVersionKind = CRDGroupVersion.WithKind(LocalDockerV1Repository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalDockerV1Repository{}, &LocalDockerV1RepositoryList{})
}
