...
type VirtualIvyRepositoryInitParameters struct {
...
type VirtualIvyRepositoryObservation struct {
...
type VirtualIvyRepositoryParameters struct {
...
// VirtualIvyRepositorySpec defines the desired state of VirtualIvyRepository
type VirtualIvyRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualIvyRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualIvyRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualIvyRepositoryStatus defines the observed state of VirtualIvyRepository.
type VirtualIvyRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualIvyRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualIvyRepository is the Schema for the VirtualIvyRepositorys API. <no value>
...
type VirtualIvyRepository struct {
	...
	Spec              VirtualIvyRepositorySpec   `json:"spec"`
	Status            VirtualIvyRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualIvyRepositoryList contains a list of VirtualIvyRepositorys
type VirtualIvyRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualIvyRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualIvyRepository_Kind             = "VirtualIvyRepository"
	VirtualIvyRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualIvyRepository_Kind}.String()
	VirtualIvyRepository_KindAPIVersion   = VirtualIvyRepository_Kind + "." + CRDGroupVersion.String()
	VirtualIvyRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualIvyRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualIvyRepository{}, &VirtualIvyRepositoryList{})
}
