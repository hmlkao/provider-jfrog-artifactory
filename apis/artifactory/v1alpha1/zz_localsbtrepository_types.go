...
type LocalSbtRepositoryInitParameters struct {
...
type LocalSbtRepositoryObservation struct {
...
type LocalSbtRepositoryParameters struct {
...
// LocalSbtRepositorySpec defines the desired state of LocalSbtRepository
type LocalSbtRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalSbtRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalSbtRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalSbtRepositoryStatus defines the observed state of LocalSbtRepository.
type LocalSbtRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalSbtRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalSbtRepository is the Schema for the LocalSbtRepositorys API. <no value>
...
type LocalSbtRepository struct {
	...
	Spec              LocalSbtRepositorySpec   `json:"spec"`
	Status            LocalSbtRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalSbtRepositoryList contains a list of LocalSbtRepositorys
type LocalSbtRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalSbtRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalSbtRepository_Kind             = "LocalSbtRepository"
	LocalSbtRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalSbtRepository_Kind}.String()
	LocalSbtRepository_KindAPIVersion   = LocalSbtRepository_Kind + "." + CRDGroupVersion.String()
	LocalSbtRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalSbtRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalSbtRepository{}, &LocalSbtRepositoryList{})
}
