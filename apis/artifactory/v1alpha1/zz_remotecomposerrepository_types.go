...
type RemoteComposerRepositoryContentSynchronisationInitParameters struct {
...
type RemoteComposerRepositoryContentSynchronisationObservation struct {
...
type RemoteComposerRepositoryContentSynchronisationParameters struct {
...
type RemoteComposerRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteComposerRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteComposerRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteComposerRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteComposerRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteComposerRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteComposerRepositorySpec defines the desired state of RemoteComposerRepository
type RemoteComposerRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteComposerRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteComposerRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteComposerRepositoryStatus defines the observed state of RemoteComposerRepository.
type RemoteComposerRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteComposerRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteComposerRepository is the Schema for the RemoteComposerRepositorys API. <no value>
...
type RemoteComposerRepository struct {
	...
	Spec   RemoteComposerRepositorySpec   `json:"spec"`
	Status RemoteComposerRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteComposerRepositoryList contains a list of RemoteComposerRepositorys
type RemoteComposerRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteComposerRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteComposerRepository_Kind             = "RemoteComposerRepository"
	RemoteComposerRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteComposerRepository_Kind}.String()
	RemoteComposerRepository_KindAPIVersion   = RemoteComposerRepository_Kind + "." + CRDGroupVersion.String()
	RemoteComposerRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteComposerRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteComposerRepository{}, &RemoteComposerRepositoryList{})
}
