...
type LocalIvyRepositoryInitParameters struct {
...
type LocalIvyRepositoryObservation struct {
...
type LocalIvyRepositoryParameters struct {
...
// LocalIvyRepositorySpec defines the desired state of LocalIvyRepository
type LocalIvyRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalIvyRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalIvyRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalIvyRepositoryStatus defines the observed state of LocalIvyRepository.
type LocalIvyRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalIvyRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalIvyRepository is the Schema for the LocalIvyRepositorys API. <no value>
...
type LocalIvyRepository struct {
	...
	Spec              LocalIvyRepositorySpec   `json:"spec"`
	Status            LocalIvyRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalIvyRepositoryList contains a list of LocalIvyRepositorys
type LocalIvyRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalIvyRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalIvyRepository_Kind             = "LocalIvyRepository"
	LocalIvyRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalIvyRepository_Kind}.String()
	LocalIvyRepository_KindAPIVersion   = LocalIvyRepository_Kind + "." + CRDGroupVersion.String()
	LocalIvyRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalIvyRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalIvyRepository{}, &LocalIvyRepositoryList{})
}
