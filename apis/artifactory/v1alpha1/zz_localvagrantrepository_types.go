...
type LocalVagrantRepositoryInitParameters struct {
...
type LocalVagrantRepositoryObservation struct {
...
type LocalVagrantRepositoryParameters struct {
...
// LocalVagrantRepositorySpec defines the desired state of LocalVagrantRepository
type LocalVagrantRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalVagrantRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalVagrantRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalVagrantRepositoryStatus defines the observed state of LocalVagrantRepository.
type LocalVagrantRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalVagrantRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalVagrantRepository is the Schema for the LocalVagrantRepositorys API. <no value>
...
type LocalVagrantRepository struct {
	...
	Spec              LocalVagrantRepositorySpec   `json:"spec"`
	Status            LocalVagrantRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalVagrantRepositoryList contains a list of LocalVagrantRepositorys
type LocalVagrantRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalVagrantRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalVagrantRepository_Kind             = "LocalVagrantRepository"
	LocalVagrantRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalVagrantRepository_Kind}.String()
	LocalVagrantRepository_KindAPIVersion   = LocalVagrantRepository_Kind + "." + CRDGroupVersion.String()
	LocalVagrantRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalVagrantRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalVagrantRepository{}, &LocalVagrantRepositoryList{})
}
