...
type VirtualGoRepositoryInitParameters struct {
...
type VirtualGoRepositoryObservation struct {
...
type VirtualGoRepositoryParameters struct {
...
// VirtualGoRepositorySpec defines the desired state of VirtualGoRepository
type VirtualGoRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualGoRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualGoRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualGoRepositoryStatus defines the observed state of VirtualGoRepository.
type VirtualGoRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualGoRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualGoRepository is the Schema for the VirtualGoRepositorys API. <no value>
...
type VirtualGoRepository struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              VirtualGoRepositorySpec   `json:"spec"`
	Status            VirtualGoRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualGoRepositoryList contains a list of VirtualGoRepositorys
type VirtualGoRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualGoRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualGoRepository_Kind             = "VirtualGoRepository"
	VirtualGoRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualGoRepository_Kind}.String()
	VirtualGoRepository_KindAPIVersion   = VirtualGoRepository_Kind + "." + CRDGroupVersion.String()
	VirtualGoRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualGoRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualGoRepository{}, &VirtualGoRepositoryList{})
}
