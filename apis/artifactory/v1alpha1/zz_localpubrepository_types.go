...
type LocalPubRepositoryInitParameters struct {
...
type LocalPubRepositoryObservation struct {
...
type LocalPubRepositoryParameters struct {
...
// LocalPubRepositorySpec defines the desired state of LocalPubRepository
type LocalPubRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalPubRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalPubRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalPubRepositoryStatus defines the observed state of LocalPubRepository.
type LocalPubRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalPubRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalPubRepository is the Schema for the LocalPubRepositorys API. <no value>
...
type LocalPubRepository struct {
	...
	Spec              LocalPubRepositorySpec   `json:"spec"`
	Status            LocalPubRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalPubRepositoryList contains a list of LocalPubRepositorys
type LocalPubRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalPubRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalPubRepository_Kind             = "LocalPubRepository"
	LocalPubRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalPubRepository_Kind}.String()
	LocalPubRepository_KindAPIVersion   = LocalPubRepository_Kind + "." + CRDGroupVersion.String()
	LocalPubRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalPubRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalPubRepository{}, &LocalPubRepositoryList{})
}
