...
type RemoteIvyRepositoryContentSynchronisationInitParameters struct {
...
type RemoteIvyRepositoryContentSynchronisationObservation struct {
...
type RemoteIvyRepositoryContentSynchronisationParameters struct {
...
type RemoteIvyRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteIvyRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteIvyRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteIvyRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteIvyRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteIvyRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteIvyRepositorySpec defines the desired state of RemoteIvyRepository
type RemoteIvyRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteIvyRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteIvyRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteIvyRepositoryStatus defines the observed state of RemoteIvyRepository.
type RemoteIvyRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteIvyRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteIvyRepository is the Schema for the RemoteIvyRepositorys API. <no value>
...
type RemoteIvyRepository struct {
	...
	Spec   RemoteIvyRepositorySpec   `json:"spec"`
	Status RemoteIvyRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteIvyRepositoryList contains a list of RemoteIvyRepositorys
type RemoteIvyRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteIvyRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteIvyRepository_Kind             = "RemoteIvyRepository"
	RemoteIvyRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteIvyRepository_Kind}.String()
	RemoteIvyRepository_KindAPIVersion   = RemoteIvyRepository_Kind + "." + CRDGroupVersion.String()
	RemoteIvyRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteIvyRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteIvyRepository{}, &RemoteIvyRepositoryList{})
}
