...
type RemoteOCIRepositoryContentSynchronisationInitParameters struct {
...
type RemoteOCIRepositoryContentSynchronisationObservation struct {
...
type RemoteOCIRepositoryContentSynchronisationParameters struct {
...
type RemoteOCIRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteOCIRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteOCIRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteOCIRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteOCIRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteOCIRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteOCIRepositorySpec defines the desired state of RemoteOCIRepository
type RemoteOCIRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteOCIRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteOCIRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteOCIRepositoryStatus defines the observed state of RemoteOCIRepository.
type RemoteOCIRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteOCIRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteOCIRepository is the Schema for the RemoteOCIRepositorys API. <no value>
...
type RemoteOCIRepository struct {
	...
	Spec   RemoteOCIRepositorySpec   `json:"spec"`
	Status RemoteOCIRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteOCIRepositoryList contains a list of RemoteOCIRepositorys
type RemoteOCIRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteOCIRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteOCIRepository_Kind             = "RemoteOCIRepository"
	RemoteOCIRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteOCIRepository_Kind}.String()
	RemoteOCIRepository_KindAPIVersion   = RemoteOCIRepository_Kind + "." + CRDGroupVersion.String()
	RemoteOCIRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteOCIRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteOCIRepository{}, &RemoteOCIRepositoryList{})
}
