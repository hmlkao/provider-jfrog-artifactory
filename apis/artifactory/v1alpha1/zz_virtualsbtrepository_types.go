...
type VirtualSbtRepositoryInitParameters struct {
...
type VirtualSbtRepositoryObservation struct {
...
type VirtualSbtRepositoryParameters struct {
...
// VirtualSbtRepositorySpec defines the desired state of VirtualSbtRepository
type VirtualSbtRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualSbtRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualSbtRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualSbtRepositoryStatus defines the observed state of VirtualSbtRepository.
type VirtualSbtRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualSbtRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualSbtRepository is the Schema for the VirtualSbtRepositorys API. <no value>
...
type VirtualSbtRepository struct {
	...
	Spec              VirtualSbtRepositorySpec   `json:"spec"`
	Status            VirtualSbtRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualSbtRepositoryList contains a list of VirtualSbtRepositorys
type VirtualSbtRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualSbtRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualSbtRepository_Kind             = "VirtualSbtRepository"
	VirtualSbtRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualSbtRepository_Kind}.String()
	VirtualSbtRepository_KindAPIVersion   = VirtualSbtRepository_Kind + "." + CRDGroupVersion.String()
	VirtualSbtRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualSbtRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualSbtRepository{}, &VirtualSbtRepositoryList{})
}
