...
type RemoteHuggingfacemlRepositoryContentSynchronisationInitParameters struct {
...
type RemoteHuggingfacemlRepositoryContentSynchronisationObservation struct {
...
type RemoteHuggingfacemlRepositoryContentSynchronisationParameters struct {
...
type RemoteHuggingfacemlRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteHuggingfacemlRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteHuggingfacemlRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteHuggingfacemlRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteHuggingfacemlRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteHuggingfacemlRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteHuggingfacemlRepositorySpec defines the desired state of RemoteHuggingfacemlRepository
type RemoteHuggingfacemlRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteHuggingfacemlRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteHuggingfacemlRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteHuggingfacemlRepositoryStatus defines the observed state of RemoteHuggingfacemlRepository.
type RemoteHuggingfacemlRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteHuggingfacemlRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteHuggingfacemlRepository is the Schema for the RemoteHuggingfacemlRepositorys API. <no value>
...
type RemoteHuggingfacemlRepository struct {
	...
	Spec              RemoteHuggingfacemlRepositorySpec   `json:"spec"`
	Status            RemoteHuggingfacemlRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteHuggingfacemlRepositoryList contains a list of RemoteHuggingfacemlRepositorys
type RemoteHuggingfacemlRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteHuggingfacemlRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteHuggingfacemlRepository_Kind             = "RemoteHuggingfacemlRepository"
	RemoteHuggingfacemlRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteHuggingfacemlRepository_Kind}.String()
	RemoteHuggingfacemlRepository_KindAPIVersion   = RemoteHuggingfacemlRepository_Kind + "." + CRDGroupVersion.String()
	RemoteHuggingfacemlRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteHuggingfacemlRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteHuggingfacemlRepository{}, &RemoteHuggingfacemlRepositoryList{})
}
