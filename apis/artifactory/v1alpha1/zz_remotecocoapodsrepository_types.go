...
type RemoteCocoapodsRepositoryContentSynchronisationInitParameters struct {
...
type RemoteCocoapodsRepositoryContentSynchronisationObservation struct {
...
type RemoteCocoapodsRepositoryContentSynchronisationParameters struct {
...
type RemoteCocoapodsRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteCocoapodsRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteCocoapodsRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteCocoapodsRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteCocoapodsRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteCocoapodsRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteCocoapodsRepositorySpec defines the desired state of RemoteCocoapodsRepository
type RemoteCocoapodsRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteCocoapodsRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteCocoapodsRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteCocoapodsRepositoryStatus defines the observed state of RemoteCocoapodsRepository.
type RemoteCocoapodsRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteCocoapodsRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteCocoapodsRepository is the Schema for the RemoteCocoapodsRepositorys API. <no value>
...
type RemoteCocoapodsRepository struct {
	...
	Spec   RemoteCocoapodsRepositorySpec   `json:"spec"`
	Status RemoteCocoapodsRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteCocoapodsRepositoryList contains a list of RemoteCocoapodsRepositorys
type RemoteCocoapodsRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteCocoapodsRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteCocoapodsRepository_Kind             = "RemoteCocoapodsRepository"
	RemoteCocoapodsRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteCocoapodsRepository_Kind}.String()
	RemoteCocoapodsRepository_KindAPIVersion   = RemoteCocoapodsRepository_Kind + "." + CRDGroupVersion.String()
	RemoteCocoapodsRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteCocoapodsRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteCocoapodsRepository{}, &RemoteCocoapodsRepositoryList{})
}
