...
type RemotePuppetRepositoryContentSynchronisationInitParameters struct {
...
type RemotePuppetRepositoryContentSynchronisationObservation struct {
...
type RemotePuppetRepositoryContentSynchronisationParameters struct {
...
type RemotePuppetRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemotePuppetRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemotePuppetRepositoryObservation struct {
	...
	ContentSynchronisation []RemotePuppetRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemotePuppetRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemotePuppetRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemotePuppetRepositorySpec defines the desired state of RemotePuppetRepository
type RemotePuppetRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemotePuppetRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemotePuppetRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemotePuppetRepositoryStatus defines the observed state of RemotePuppetRepository.
type RemotePuppetRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemotePuppetRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemotePuppetRepository is the Schema for the RemotePuppetRepositorys API. <no value>
...
type RemotePuppetRepository struct {
	...
	Spec   RemotePuppetRepositorySpec   `json:"spec"`
	Status RemotePuppetRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemotePuppetRepositoryList contains a list of RemotePuppetRepositorys
type RemotePuppetRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemotePuppetRepository `json:"items"`
}

// Repository type metadata.
var (
	RemotePuppetRepository_Kind             = "RemotePuppetRepository"
	RemotePuppetRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemotePuppetRepository_Kind}.String()
	RemotePuppetRepository_KindAPIVersion   = RemotePuppetRepository_Kind + "." + CRDGroupVersion.String()
	RemotePuppetRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemotePuppetRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemotePuppetRepository{}, &RemotePuppetRepositoryList{})
}
