...
type RemoteCargoRepositoryContentSynchronisationInitParameters struct {
...
type RemoteCargoRepositoryContentSynchronisationObservation struct {
...
type RemoteCargoRepositoryContentSynchronisationParameters struct {
...
type RemoteCargoRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteCargoRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteCargoRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteCargoRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteCargoRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteCargoRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteCargoRepositorySpec defines the desired state of RemoteCargoRepository
type RemoteCargoRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteCargoRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteCargoRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteCargoRepositoryStatus defines the observed state of RemoteCargoRepository.
type RemoteCargoRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteCargoRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteCargoRepository is the Schema for the RemoteCargoRepositorys API. <no value>
...
type RemoteCargoRepository struct {
	...
	Spec   RemoteCargoRepositorySpec   `json:"spec"`
	Status RemoteCargoRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteCargoRepositoryList contains a list of RemoteCargoRepositorys
type RemoteCargoRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteCargoRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteCargoRepository_Kind             = "RemoteCargoRepository"
	RemoteCargoRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteCargoRepository_Kind}.String()
	RemoteCargoRepository_KindAPIVersion   = RemoteCargoRepository_Kind + "." + CRDGroupVersion.String()
	RemoteCargoRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteCargoRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteCargoRepository{}, &RemoteCargoRepositoryList{})
}
