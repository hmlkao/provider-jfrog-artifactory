...
type LocalAlpineRepositoryInitParameters struct {
...
type LocalAlpineRepositoryObservation struct {
...
type LocalAlpineRepositoryParameters struct {
...
// LocalAlpineRepositorySpec defines the desired state of LocalAlpineRepository
type LocalAlpineRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalAlpineRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalAlpineRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalAlpineRepositoryStatus defines the observed state of LocalAlpineRepository.
type LocalAlpineRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalAlpineRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalAlpineRepository is the Schema for the LocalAlpineRepositorys API. <no value>
...
type LocalAlpineRepository struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              LocalAlpineRepositorySpec   `json:"spec"`
	Status            LocalAlpineRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalAlpineRepositoryList contains a list of LocalAlpineRepositorys
type LocalAlpineRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalAlpineRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalAlpineRepository_Kind             = "LocalAlpineRepository"
	LocalAlpineRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalAlpineRepository_Kind}.String()
	LocalAlpineRepository_KindAPIVersion   = LocalAlpineRepository_Kind + "." + CRDGroupVersion.String()
	LocalAlpineRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalAlpineRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalAlpineRepository{}, &LocalAlpineRepositoryList{})
}
