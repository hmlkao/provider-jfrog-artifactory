...
type RemoteChefRepositoryContentSynchronisationInitParameters struct {
...
type RemoteChefRepositoryContentSynchronisationObservation struct {
...
type RemoteChefRepositoryContentSynchronisationParameters struct {
...
type RemoteChefRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteChefRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteChefRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteChefRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteChefRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteChefRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteChefRepositorySpec defines the desired state of RemoteChefRepository
type RemoteChefRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteChefRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteChefRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteChefRepositoryStatus defines the observed state of RemoteChefRepository.
type RemoteChefRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteChefRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteChefRepository is the Schema for the RemoteChefRepositorys API. <no value>
...
type RemoteChefRepository struct {
	...
	Spec   RemoteChefRepositorySpec   `json:"spec"`
	Status RemoteChefRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteChefRepositoryList contains a list of RemoteChefRepositorys
type RemoteChefRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteChefRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteChefRepository_Kind             = "RemoteChefRepository"
	RemoteChefRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteChefRepository_Kind}.String()
	RemoteChefRepository_KindAPIVersion   = RemoteChefRepository_Kind + "." + CRDGroupVersion.String()
	RemoteChefRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteChefRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteChefRepository{}, &RemoteChefRepositoryList{})
}
