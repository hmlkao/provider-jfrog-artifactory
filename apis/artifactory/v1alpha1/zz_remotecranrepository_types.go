...
type RemoteCranRepositoryContentSynchronisationInitParameters struct {
...
type RemoteCranRepositoryContentSynchronisationObservation struct {
...
type RemoteCranRepositoryContentSynchronisationParameters struct {
...
type RemoteCranRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteCranRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteCranRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteCranRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteCranRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteCranRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteCranRepositorySpec defines the desired state of RemoteCranRepository
type RemoteCranRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteCranRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteCranRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteCranRepositoryStatus defines the observed state of RemoteCranRepository.
type RemoteCranRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteCranRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteCranRepository is the Schema for the RemoteCranRepositorys API. <no value>
...
type RemoteCranRepository struct {
	...
	Spec   RemoteCranRepositorySpec   `json:"spec"`
	Status RemoteCranRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteCranRepositoryList contains a list of RemoteCranRepositorys
type RemoteCranRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteCranRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteCranRepository_Kind             = "RemoteCranRepository"
	RemoteCranRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteCranRepository_Kind}.String()
	RemoteCranRepository_KindAPIVersion   = RemoteCranRepository_Kind + "." + CRDGroupVersion.String()
	RemoteCranRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteCranRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteCranRepository{}, &RemoteCranRepositoryList{})
}
