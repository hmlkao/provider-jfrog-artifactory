...
type RemoteSBTRepositoryContentSynchronisationInitParameters struct {
...
type RemoteSBTRepositoryContentSynchronisationObservation struct {
...
type RemoteSBTRepositoryContentSynchronisationParameters struct {
...
type RemoteSBTRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteSBTRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteSBTRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteSBTRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteSBTRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteSBTRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteSBTRepositorySpec defines the desired state of RemoteSBTRepository
type RemoteSBTRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteSBTRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteSBTRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteSBTRepositoryStatus defines the observed state of RemoteSBTRepository.
type RemoteSBTRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteSBTRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteSBTRepository is the Schema for the RemoteSBTRepositorys API. <no value>
...
type RemoteSBTRepository struct {
	...
	Spec   RemoteSBTRepositorySpec   `json:"spec"`
	Status RemoteSBTRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteSBTRepositoryList contains a list of RemoteSBTRepositorys
type RemoteSBTRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteSBTRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteSBTRepository_Kind             = "RemoteSBTRepository"
	RemoteSBTRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteSBTRepository_Kind}.String()
	RemoteSBTRepository_KindAPIVersion   = RemoteSBTRepository_Kind + "." + CRDGroupVersion.String()
	RemoteSBTRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteSBTRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteSBTRepository{}, &RemoteSBTRepositoryList{})
}
