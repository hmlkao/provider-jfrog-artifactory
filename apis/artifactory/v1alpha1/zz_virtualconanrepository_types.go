...
type VirtualConanRepositoryInitParameters struct {
...
type VirtualConanRepositoryObservation struct {
...
type VirtualConanRepositoryParameters struct {
...
// VirtualConanRepositorySpec defines the desired state of VirtualConanRepository
type VirtualConanRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualConanRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualConanRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualConanRepositoryStatus defines the observed state of VirtualConanRepository.
type VirtualConanRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualConanRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualConanRepository is the Schema for the VirtualConanRepositorys API. <no value>
...
type VirtualConanRepository struct {
	...
	Spec              VirtualConanRepositorySpec   `json:"spec"`
	Status            VirtualConanRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualConanRepositoryList contains a list of VirtualConanRepositorys
type VirtualConanRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualConanRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualConanRepository_Kind             = "VirtualConanRepository"
	VirtualConanRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualConanRepository_Kind}.String()
	VirtualConanRepository_KindAPIVersion   = VirtualConanRepository_Kind + "." + CRDGroupVersion.String()
	VirtualConanRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualConanRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualConanRepository{}, &VirtualConanRepositoryList{})
}
