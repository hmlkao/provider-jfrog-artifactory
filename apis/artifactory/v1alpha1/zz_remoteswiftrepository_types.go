...
type RemoteSwiftRepositoryContentSynchronisationInitParameters struct {
...
type RemoteSwiftRepositoryContentSynchronisationObservation struct {
...
type RemoteSwiftRepositoryContentSynchronisationParameters struct {
...
type RemoteSwiftRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteSwiftRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteSwiftRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteSwiftRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteSwiftRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteSwiftRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteSwiftRepositorySpec defines the desired state of RemoteSwiftRepository
type RemoteSwiftRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteSwiftRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteSwiftRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteSwiftRepositoryStatus defines the observed state of RemoteSwiftRepository.
type RemoteSwiftRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteSwiftRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteSwiftRepository is the Schema for the RemoteSwiftRepositorys API. <no value>
...
type RemoteSwiftRepository struct {
	...
	Spec   RemoteSwiftRepositorySpec   `json:"spec"`
	Status RemoteSwiftRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteSwiftRepositoryList contains a list of RemoteSwiftRepositorys
type RemoteSwiftRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteSwiftRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteSwiftRepository_Kind             = "RemoteSwiftRepository"
	RemoteSwiftRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteSwiftRepository_Kind}.String()
	RemoteSwiftRepository_KindAPIVersion   = RemoteSwiftRepository_Kind + "." + CRDGroupVersion.String()
	RemoteSwiftRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteSwiftRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteSwiftRepository{}, &RemoteSwiftRepositoryList{})
}
