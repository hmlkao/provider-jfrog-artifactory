...
type VirtualRpmRepositoryInitParameters struct {
...
type VirtualRpmRepositoryObservation struct {
...
type VirtualRpmRepositoryParameters struct {
...
// VirtualRpmRepositorySpec defines the desired state of VirtualRpmRepository
type VirtualRpmRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualRpmRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualRpmRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualRpmRepositoryStatus defines the observed state of VirtualRpmRepository.
type VirtualRpmRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualRpmRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualRpmRepository is the Schema for the VirtualRpmRepositorys API. <no value>
...
type VirtualRpmRepository struct {
	...
	Spec              VirtualRpmRepositorySpec   `json:"spec"`
	Status            VirtualRpmRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualRpmRepositoryList contains a list of VirtualRpmRepositorys
type VirtualRpmRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualRpmRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualRpmRepository_Kind             = "VirtualRpmRepository"
	VirtualRpmRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualRpmRepository_Kind}.String()
	VirtualRpmRepository_KindAPIVersion   = VirtualRpmRepository_Kind + "." + CRDGroupVersion.String()
	VirtualRpmRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualRpmRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualRpmRepository{}, &VirtualRpmRepositoryList{})
}
