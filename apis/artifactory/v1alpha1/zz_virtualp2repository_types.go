...
type VirtualP2RepositoryInitParameters struct {
...
type VirtualP2RepositoryObservation struct {
...
type VirtualP2RepositoryParameters struct {
...
// VirtualP2RepositorySpec defines the desired state of VirtualP2Repository
type VirtualP2RepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualP2RepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualP2RepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualP2RepositoryStatus defines the observed state of VirtualP2Repository.
type VirtualP2RepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualP2RepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualP2Repository is the Schema for the VirtualP2Repositorys API. <no value>
...
type VirtualP2Repository struct {
	...
	Spec              VirtualP2RepositorySpec   `json:"spec"`
	Status            VirtualP2RepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualP2RepositoryList contains a list of VirtualP2Repositorys
type VirtualP2RepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualP2Repository `json:"items"`
}

// Repository type metadata.
var (
	VirtualP2Repository_Kind             = "VirtualP2Repository"
	VirtualP2Repository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualP2Repository_Kind}.String()
	VirtualP2Repository_KindAPIVersion   = VirtualP2Repository_Kind + "." + CRDGroupVersion.String()
	VirtualP2Repository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualP2Repository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualP2Repository{}, &VirtualP2RepositoryList{})
}
