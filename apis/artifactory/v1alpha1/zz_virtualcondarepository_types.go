...
type VirtualCondaRepositoryInitParameters struct {
...
type VirtualCondaRepositoryObservation struct {
...
type VirtualCondaRepositoryParameters struct {
...
// VirtualCondaRepositorySpec defines the desired state of VirtualCondaRepository
type VirtualCondaRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualCondaRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualCondaRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualCondaRepositoryStatus defines the observed state of VirtualCondaRepository.
type VirtualCondaRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualCondaRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualCondaRepository is the Schema for the VirtualCondaRepositorys API. <no value>
...
type VirtualCondaRepository struct {
	...
	Spec              VirtualCondaRepositorySpec   `json:"spec"`
	Status            VirtualCondaRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualCondaRepositoryList contains a list of VirtualCondaRepositorys
type VirtualCondaRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualCondaRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualCondaRepository_Kind             = "VirtualCondaRepository"
	VirtualCondaRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualCondaRepository_Kind}.String()
	VirtualCondaRepository_KindAPIVersion   = VirtualCondaRepository_Kind + "." + CRDGroupVersion.String()
	VirtualCondaRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualCondaRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualCondaRepository{}, &VirtualCondaRepositoryList{})
}
