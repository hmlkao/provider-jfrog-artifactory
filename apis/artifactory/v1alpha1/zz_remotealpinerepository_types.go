...
type RemoteAlpineRepositoryInitParameters struct {
...
type RemoteAlpineRepositoryObservation struct {
...
type RemoteAlpineRepositoryParameters struct {
...
// RemoteAlpineRepositorySpec defines the desired state of RemoteAlpineRepository
type RemoteAlpineRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteAlpineRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteAlpineRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteAlpineRepositoryStatus defines the observed state of RemoteAlpineRepository.
type RemoteAlpineRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteAlpineRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteAlpineRepository is the Schema for the RemoteAlpineRepositorys API. <no value>
...
type RemoteAlpineRepository struct {
	...
	Spec   RemoteAlpineRepositorySpec   `json:"spec"`
	Status RemoteAlpineRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteAlpineRepositoryList contains a list of RemoteAlpineRepositorys
type RemoteAlpineRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteAlpineRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteAlpineRepository_Kind             = "RemoteAlpineRepository"
	RemoteAlpineRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteAlpineRepository_Kind}.String()
	RemoteAlpineRepository_KindAPIVersion   = RemoteAlpineRepository_Kind + "." + CRDGroupVersion.String()
	RemoteAlpineRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteAlpineRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteAlpineRepository{}, &RemoteAlpineRepositoryList{})
}
