...
type VirtualPubRepositoryInitParameters struct {
...
type VirtualPubRepositoryObservation struct {
...
type VirtualPubRepositoryParameters struct {
...
// VirtualPubRepositorySpec defines the desired state of VirtualPubRepository
type VirtualPubRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualPubRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualPubRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualPubRepositoryStatus defines the observed state of VirtualPubRepository.
type VirtualPubRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualPubRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualPubRepository is the Schema for the VirtualPubRepositorys API. <no value>
...
type VirtualPubRepository struct {
	...
	Spec              VirtualPubRepositorySpec   `json:"spec"`
	Status            VirtualPubRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualPubRepositoryList contains a list of VirtualPubRepositorys
type VirtualPubRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualPubRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualPubRepository_Kind             = "VirtualPubRepository"
	VirtualPubRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualPubRepository_Kind}.String()
	VirtualPubRepository_KindAPIVersion   = VirtualPubRepository_Kind + "." + CRDGroupVersion.String()
	VirtualPubRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualPubRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualPubRepository{}, &VirtualPubRepositoryList{})
}
