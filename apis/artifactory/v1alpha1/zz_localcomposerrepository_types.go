...
type LocalComposerRepositoryInitParameters struct {
...
type LocalComposerRepositoryObservation struct {
...
type LocalComposerRepositoryParameters struct {
...
// LocalComposerRepositorySpec defines the desired state of LocalComposerRepository
type LocalComposerRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalComposerRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalComposerRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalComposerRepositoryStatus defines the observed state of LocalComposerRepository.
type LocalComposerRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalComposerRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalComposerRepository is the Schema for the LocalComposerRepositorys API. <no value>
...
type LocalComposerRepository struct {
	...
	Spec              LocalComposerRepositorySpec   `json:"spec"`
	Status            LocalComposerRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalComposerRepositoryList contains a list of LocalComposerRepositorys
type LocalComposerRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalComposerRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalComposerRepository_Kind             = "LocalComposerRepository"
	LocalComposerRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalComposerRepository_Kind}.String()
	LocalComposerRepository_KindAPIVersion   = LocalComposerRepository_Kind + "." + CRDGroupVersion.String()
	LocalComposerRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalComposerRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalComposerRepository{}, &LocalComposerRepositoryList{})
}
