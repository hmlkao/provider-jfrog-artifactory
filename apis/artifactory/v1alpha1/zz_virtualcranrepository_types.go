...
type VirtualCranRepositoryInitParameters struct {
...
type VirtualCranRepositoryObservation struct {
...
type VirtualCranRepositoryParameters struct {
...
// VirtualCranRepositorySpec defines the desired state of VirtualCranRepository
type VirtualCranRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualCranRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualCranRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualCranRepositoryStatus defines the observed state of VirtualCranRepository.
type VirtualCranRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualCranRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualCranRepository is the Schema for the VirtualCranRepositorys API. <no value>
...
type VirtualCranRepository struct {
	...
	Spec              VirtualCranRepositorySpec   `json:"spec"`
	Status            VirtualCranRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualCranRepositoryList contains a list of VirtualCranRepositorys
type VirtualCranRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualCranRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualCranRepository_Kind             = "VirtualCranRepository"
	VirtualCranRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualCranRepository_Kind}.String()
	VirtualCranRepository_KindAPIVersion   = VirtualCranRepository_Kind + "." + CRDGroupVersion.String()
	VirtualCranRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualCranRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualCranRepository{}, &VirtualCranRepositoryList{})
}
