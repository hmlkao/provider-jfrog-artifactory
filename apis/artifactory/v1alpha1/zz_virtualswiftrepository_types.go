...
type VirtualSwiftRepositoryInitParameters struct {
...
type VirtualSwiftRepositoryObservation struct {
...
type VirtualSwiftRepositoryParameters struct {
...
// VirtualSwiftRepositorySpec defines the desired state of VirtualSwiftRepository
type VirtualSwiftRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualSwiftRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualSwiftRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualSwiftRepositoryStatus defines the observed state of VirtualSwiftRepository.
type VirtualSwiftRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualSwiftRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualSwiftRepository is the Schema for the VirtualSwiftRepositorys API. <no value>
...
type VirtualSwiftRepository struct {
	...
	Spec              VirtualSwiftRepositorySpec   `json:"spec"`
	Status            VirtualSwiftRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualSwiftRepositoryList contains a list of VirtualSwiftRepositorys
type VirtualSwiftRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualSwiftRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualSwiftRepository_Kind             = "VirtualSwiftRepository"
	VirtualSwiftRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualSwiftRepository_Kind}.String()
	VirtualSwiftRepository_KindAPIVersion   = VirtualSwiftRepository_Kind + "." + CRDGroupVersion.String()
	VirtualSwiftRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualSwiftRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualSwiftRepository{}, &VirtualSwiftRepositoryList{})
}
