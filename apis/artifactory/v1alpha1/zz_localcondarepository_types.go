...
type LocalCondaRepositoryInitParameters struct {
...
type LocalCondaRepositoryObservation struct {
...
type LocalCondaRepositoryParameters struct {
...
// LocalCondaRepositorySpec defines the desired state of LocalCondaRepository
type LocalCondaRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalCondaRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalCondaRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalCondaRepositoryStatus defines the observed state of LocalCondaRepository.
type LocalCondaRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalCondaRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalCondaRepository is the Schema for the LocalCondaRepositorys API. <no value>
...
type LocalCondaRepository struct {
	...
	Spec              LocalCondaRepositorySpec   `json:"spec"`
	Status            LocalCondaRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalCondaRepositoryList contains a list of LocalCondaRepositorys
type LocalCondaRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalCondaRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalCondaRepository_Kind             = "LocalCondaRepository"
	LocalCondaRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalCondaRepository_Kind}.String()
	LocalCondaRepository_KindAPIVersion   = LocalCondaRepository_Kind + "." + CRDGroupVersion.String()
	LocalCondaRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalCondaRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalCondaRepository{}, &LocalCondaRepositoryList{})
}
