...
type RemoteNugetRepositoryContentSynchronisationInitParameters struct {
...
type RemoteNugetRepositoryContentSynchronisationObservation struct {
...
type RemoteNugetRepositoryContentSynchronisationParameters struct {
...
type RemoteNugetRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteNugetRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteNugetRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteNugetRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteNugetRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteNugetRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteNugetRepositorySpec defines the desired state of RemoteNugetRepository
type RemoteNugetRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteNugetRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteNugetRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteNugetRepositoryStatus defines the observed state of RemoteNugetRepository.
type RemoteNugetRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteNugetRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteNugetRepository is the Schema for the RemoteNugetRepositorys API. <no value>
...
type RemoteNugetRepository struct {
	...
	Spec   RemoteNugetRepositorySpec   `json:"spec"`
	Status RemoteNugetRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteNugetRepositoryList contains a list of RemoteNugetRepositorys
type RemoteNugetRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteNugetRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteNugetRepository_Kind             = "RemoteNugetRepository"
	RemoteNugetRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteNugetRepository_Kind}.String()
	RemoteNugetRepository_KindAPIVersion   = RemoteNugetRepository_Kind + "." + CRDGroupVersion.String()
	RemoteNugetRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteNugetRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteNugetRepository{}, &RemoteNugetRepositoryList{})
}
