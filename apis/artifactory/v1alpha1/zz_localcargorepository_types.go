...
type LocalCargoRepositoryInitParameters struct {
...
type LocalCargoRepositoryObservation struct {
...
type LocalCargoRepositoryParameters struct {
...
// LocalCargoRepositorySpec defines the desired state of LocalCargoRepository
type LocalCargoRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalCargoRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalCargoRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalCargoRepositoryStatus defines the observed state of LocalCargoRepository.
type LocalCargoRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalCargoRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalCargoRepository is the Schema for the LocalCargoRepositorys API. <no value>
...
type LocalCargoRepository struct {
	...
	Spec              LocalCargoRepositorySpec   `json:"spec"`
	Status            LocalCargoRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalCargoRepositoryList contains a list of LocalCargoRepositorys
type LocalCargoRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalCargoRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalCargoRepository_Kind             = "LocalCargoRepository"
	LocalCargoRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalCargoRepository_Kind}.String()
	LocalCargoRepository_KindAPIVersion   = LocalCargoRepository_Kind + "." + CRDGroupVersion.String()
	LocalCargoRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalCargoRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalCargoRepository{}, &LocalCargoRepositoryList{})
}
