...
type RemoteCondaRepositoryContentSynchronisationInitParameters struct {
...
type RemoteCondaRepositoryContentSynchronisationObservation struct {
...
type RemoteCondaRepositoryContentSynchronisationParameters struct {
...
type RemoteCondaRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteCondaRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteCondaRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteCondaRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteCondaRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteCondaRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteCondaRepositorySpec defines the desired state of RemoteCondaRepository
type RemoteCondaRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteCondaRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteCondaRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteCondaRepositoryStatus defines the observed state of RemoteCondaRepository.
type RemoteCondaRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteCondaRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteCondaRepository is the Schema for the RemoteCondaRepositorys API. <no value>
...
type RemoteCondaRepository struct {
	...
	Spec   RemoteCondaRepositorySpec   `json:"spec"`
	Status RemoteCondaRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteCondaRepositoryList contains a list of RemoteCondaRepositorys
type RemoteCondaRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteCondaRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteCondaRepository_Kind             = "RemoteCondaRepository"
	RemoteCondaRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteCondaRepository_Kind}.String()
	RemoteCondaRepository_KindAPIVersion   = RemoteCondaRepository_Kind + "." + CRDGroupVersion.String()
	RemoteCondaRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteCondaRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteCondaRepository{}, &RemoteCondaRepositoryList{})
}
