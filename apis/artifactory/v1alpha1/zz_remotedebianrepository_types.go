...
type RemoteDebianRepositoryContentSynchronisationInitParameters struct {
...
type RemoteDebianRepositoryContentSynchronisationObservation struct {
...
type RemoteDebianRepositoryContentSynchronisationParameters struct {
...
type RemoteDebianRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteDebianRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteDebianRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteDebianRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteDebianRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteDebianRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteDebianRepositorySpec defines the desired state of RemoteDebianRepository
type RemoteDebianRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteDebianRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteDebianRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteDebianRepositoryStatus defines the observed state of RemoteDebianRepository.
type RemoteDebianRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteDebianRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteDebianRepository is the Schema for the RemoteDebianRepositorys API. <no value>
...
type RemoteDebianRepository struct {
	...
	Spec   RemoteDebianRepositorySpec   `json:"spec"`
	Status RemoteDebianRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteDebianRepositoryList contains a list of RemoteDebianRepositorys
type RemoteDebianRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteDebianRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteDebianRepository_Kind             = "RemoteDebianRepository"
	RemoteDebianRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteDebianRepository_Kind}.String()
	RemoteDebianRepository_KindAPIVersion   = RemoteDebianRepository_Kind + "." + CRDGroupVersion.String()
	RemoteDebianRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteDebianRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteDebianRepository{}, &RemoteDebianRepositoryList{})
}
