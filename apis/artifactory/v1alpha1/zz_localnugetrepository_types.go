...
type LocalNugetRepositoryInitParameters struct {
...
type LocalNugetRepositoryObservation struct {
...
type LocalNugetRepositoryParameters struct {
...
// LocalNugetRepositorySpec defines the desired state of LocalNugetRepository
type LocalNugetRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalNugetRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalNugetRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalNugetRepositoryStatus defines the observed state of LocalNugetRepository.
type LocalNugetRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalNugetRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalNugetRepository is the Schema for the LocalNugetRepositorys API. <no value>
...
type LocalNugetRepository struct {
	...
	Spec              LocalNugetRepositorySpec   `json:"spec"`
	Status            LocalNugetRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalNugetRepositoryList contains a list of LocalNugetRepositorys
type LocalNugetRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalNugetRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalNugetRepository_Kind             = "LocalNugetRepository"
	LocalNugetRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalNugetRepository_Kind}.String()
	LocalNugetRepository_KindAPIVersion   = LocalNugetRepository_Kind + "." + CRDGroupVersion.String()
	LocalNugetRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalNugetRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalNugetRepository{}, &LocalNugetRepositoryList{})
}
