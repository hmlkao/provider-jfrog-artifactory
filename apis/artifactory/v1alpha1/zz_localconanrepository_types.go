...
type LocalConanRepositoryInitParameters struct {
...
type LocalConanRepositoryObservation struct {
...
type LocalConanRepositoryParameters struct {
...
// LocalConanRepositorySpec defines the desired state of LocalConanRepository
type LocalConanRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalConanRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalConanRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalConanRepositoryStatus defines the observed state of LocalConanRepository.
type LocalConanRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalConanRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalConanRepository is the Schema for the LocalConanRepositorys API. <no value>
...
type LocalConanRepository struct {
	...
	Spec              LocalConanRepositorySpec   `json:"spec"`
	Status            LocalConanRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalConanRepositoryList contains a list of LocalConanRepositorys
type LocalConanRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalConanRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalConanRepository_Kind             = "LocalConanRepository"
	LocalConanRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalConanRepository_Kind}.String()
	LocalConanRepository_KindAPIVersion   = LocalConanRepository_Kind + "." + CRDGroupVersion.String()
	LocalConanRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalConanRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalConanRepository{}, &LocalConanRepositoryList{})
}
