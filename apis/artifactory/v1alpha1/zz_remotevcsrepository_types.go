...
type RemoteVCSRepositoryContentSynchronisationInitParameters struct {
...
type RemoteVCSRepositoryContentSynchronisationObservation struct {
...
type RemoteVCSRepositoryContentSynchronisationParameters struct {
...
type RemoteVCSRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteVCSRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteVCSRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteVCSRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteVCSRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteVCSRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteVCSRepositorySpec defines the desired state of RemoteVCSRepository
type RemoteVCSRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteVCSRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteVCSRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteVCSRepositoryStatus defines the observed state of RemoteVCSRepository.
type RemoteVCSRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteVCSRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteVCSRepository is the Schema for the RemoteVCSRepositorys API. <no value>
...
type RemoteVCSRepository struct {
	...
	Spec   RemoteVCSRepositorySpec   `json:"spec"`
	Status RemoteVCSRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteVCSRepositoryList contains a list of RemoteVCSRepositorys
type RemoteVCSRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteVCSRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteVCSRepository_Kind             = "RemoteVCSRepository"
	RemoteVCSRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteVCSRepository_Kind}.String()
	RemoteVCSRepository_KindAPIVersion   = RemoteVCSRepository_Kind + "." + CRDGroupVersion.String()
	RemoteVCSRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteVCSRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteVCSRepository{}, &RemoteVCSRepositoryList{})
}
