...
type LocalPuppetRepositoryInitParameters struct {
...
type LocalPuppetRepositoryObservation struct {
...
type LocalPuppetRepositoryParameters struct {
...
// LocalPuppetRepositorySpec defines the desired state of LocalPuppetRepository
type LocalPuppetRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalPuppetRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalPuppetRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalPuppetRepositoryStatus defines the observed state of LocalPuppetRepository.
type LocalPuppetRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalPuppetRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalPuppetRepository is the Schema for the LocalPuppetRepositorys API. <no value>
...
type LocalPuppetRepository struct {
	...
	Spec              LocalPuppetRepositorySpec   `json:"spec"`
	Status            LocalPuppetRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalPuppetRepositoryList contains a list of LocalPuppetRepositorys
type LocalPuppetRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalPuppetRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalPuppetRepository_Kind             = "LocalPuppetRepository"
	LocalPuppetRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalPuppetRepository_Kind}.String()
	LocalPuppetRepository_KindAPIVersion   = LocalPuppetRepository_Kind + "." + CRDGroupVersion.String()
	LocalPuppetRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalPuppetRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalPuppetRepository{}, &LocalPuppetRepositoryList{})
}
