...
type LocalCocoapodsRepositoryInitParameters struct {
...
type LocalCocoapodsRepositoryObservation struct {
...
type LocalCocoapodsRepositoryParameters struct {
...
// LocalCocoapodsRepositorySpec defines the desired state of LocalCocoapodsRepository
type LocalCocoapodsRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalCocoapodsRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalCocoapodsRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalCocoapodsRepositoryStatus defines the observed state of LocalCocoapodsRepository.
type LocalCocoapodsRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalCocoapodsRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalCocoapodsRepository is the Schema for the LocalCocoapodsRepositorys API. <no value>
...
type LocalCocoapodsRepository struct {
	...
	Spec              LocalCocoapodsRepositorySpec   `json:"spec"`
	Status            LocalCocoapodsRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalCocoapodsRepositoryList contains a list of LocalCocoapodsRepositorys
type LocalCocoapodsRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalCocoapodsRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalCocoapodsRepository_Kind             = "LocalCocoapodsRepository"
	LocalCocoapodsRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalCocoapodsRepository_Kind}.String()
	LocalCocoapodsRepository_KindAPIVersion   = LocalCocoapodsRepository_Kind + "." + CRDGroupVersion.String()
	LocalCocoapodsRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalCocoapodsRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalCocoapodsRepository{}, &LocalCocoapodsRepositoryList{})
}
