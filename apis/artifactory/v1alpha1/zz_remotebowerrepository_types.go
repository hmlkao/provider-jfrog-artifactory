...
type RemoteBowerRepositoryContentSynchronisationInitParameters struct {
...
type RemoteBowerRepositoryContentSynchronisationObservation struct {
...
type RemoteBowerRepositoryContentSynchronisationParameters struct {
...
type RemoteBowerRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteBowerRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteBowerRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteBowerRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteBowerRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteBowerRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteBowerRepositorySpec defines the desired state of RemoteBowerRepository
type RemoteBowerRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteBowerRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteBowerRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteBowerRepositoryStatus defines the observed state of RemoteBowerRepository.
type RemoteBowerRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteBowerRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteBowerRepository is the Schema for the RemoteBowerRepositorys API. <no value>
...
type RemoteBowerRepository struct {
	...
	Spec   RemoteBowerRepositorySpec   `json:"spec"`
	Status RemoteBowerRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteBowerRepositoryList contains a list of RemoteBowerRepositorys
type RemoteBowerRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteBowerRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteBowerRepository_Kind             = "RemoteBowerRepository"
	RemoteBowerRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteBowerRepository_Kind}.String()
	RemoteBowerRepository_KindAPIVersion   = RemoteBowerRepository_Kind + "." + CRDGroupVersion.String()
	RemoteBowerRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteBowerRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteBowerRepository{}, &RemoteBowerRepositoryList{})
}
