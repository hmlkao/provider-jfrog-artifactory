...
type LocalChefRepositoryInitParameters struct {
...
type LocalChefRepositoryObservation struct {
...
type LocalChefRepositoryParameters struct {
...
// LocalChefRepositorySpec defines the desired state of LocalChefRepository
type LocalChefRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalChefRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalChefRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalChefRepositoryStatus defines the observed state of LocalChefRepository.
type LocalChefRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalChefRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalChefRepository is the Schema for the LocalChefRepositorys API. <no value>
...
type LocalChefRepository struct {
	...
	Spec              LocalChefRepositorySpec   `json:"spec"`
	Status            LocalChefRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalChefRepositoryList contains a list of LocalChefRepositorys
type LocalChefRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalChefRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalChefRepository_Kind             = "LocalChefRepository"
	LocalChefRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalChefRepository_Kind}.String()
	LocalChefRepository_KindAPIVersion   = LocalChefRepository_Kind + "." + CRDGroupVersion.String()
	LocalChefRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalChefRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalChefRepository{}, &LocalChefRepositoryList{})
}
