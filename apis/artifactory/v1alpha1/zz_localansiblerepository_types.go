...
type LocalAnsibleRepositoryInitParameters struct {
	...
	PrimaryKeypairRefRef *v1.Reference `json:"primaryKeypairRefRef,omitempty" tf:"-"`

	// Selector for a Keypair in artifactory to populate primaryKeypairRef.
	// +kubebuilder:validation:Optional
	PrimaryKeypairRefSelector *v1.Selector `json:"primaryKeypairRefSelector,omitempty" tf:"-"`
...
type LocalAnsibleRepositoryObservation struct {
...
type LocalAnsibleRepositoryParameters struct {
...
// LocalAnsibleRepositorySpec defines the desired state of LocalAnsibleRepository
type LocalAnsibleRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalAnsibleRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalAnsibleRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalAnsibleRepositoryStatus defines the observed state of LocalAnsibleRepository.
type LocalAnsibleRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalAnsibleRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalAnsibleRepository is the Schema for the LocalAnsibleRepositorys API. <no value>
...
type LocalAnsibleRepository struct {
	...
	Spec              LocalAnsibleRepositorySpec   `json:"spec"`
	Status            LocalAnsibleRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalAnsibleRepositoryList contains a list of LocalAnsibleRepositorys
type LocalAnsibleRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalAnsibleRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalAnsibleRepository_Kind             = "LocalAnsibleRepository"
	LocalAnsibleRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalAnsibleRepository_Kind}.String()
	LocalAnsibleRepository_KindAPIVersion   = LocalAnsibleRepository_Kind + "." + CRDGroupVersion.String()
	LocalAnsibleRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalAnsibleRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalAnsibleRepository{}, &LocalAnsibleRepositoryList{})
}
