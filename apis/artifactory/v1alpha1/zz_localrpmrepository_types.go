...
type LocalRPMRepositoryInitParameters struct {
...
type LocalRPMRepositoryObservation struct {
...
type LocalRPMRepositoryParameters struct {
...
// LocalRPMRepositorySpec defines the desired state of LocalRPMRepository
type LocalRPMRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalRPMRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalRPMRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalRPMRepositoryStatus defines the observed state of LocalRPMRepository.
type LocalRPMRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalRPMRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalRPMRepository is the Schema for the LocalRPMRepositorys API. <no value>
...
type LocalRPMRepository struct {
	...
	Spec              LocalRPMRepositorySpec   `json:"spec"`
	Status            LocalRPMRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalRPMRepositoryList contains a list of LocalRPMRepositorys
type LocalRPMRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalRPMRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalRPMRepository_Kind             = "LocalRPMRepository"
	LocalRPMRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalRPMRepository_Kind}.String()
	LocalRPMRepository_KindAPIVersion   = LocalRPMRepository_Kind + "." + CRDGroupVersion.String()
	LocalRPMRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalRPMRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalRPMRepository{}, &LocalRPMRepositoryList{})
}
