...
type LocalOpkgRepositoryInitParameters struct {
...
type LocalOpkgRepositoryObservation struct {
...
type LocalOpkgRepositoryParameters struct {
...
// LocalOpkgRepositorySpec defines the desired state of LocalOpkgRepository
type LocalOpkgRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalOpkgRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalOpkgRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalOpkgRepositoryStatus defines the observed state of LocalOpkgRepository.
type LocalOpkgRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalOpkgRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalOpkgRepository is the Schema for the LocalOpkgRepositorys API. <no value>
...
type LocalOpkgRepository struct {
	...
	Spec              LocalOpkgRepositorySpec   `json:"spec"`
	Status            LocalOpkgRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalOpkgRepositoryList contains a list of LocalOpkgRepositorys
type LocalOpkgRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalOpkgRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalOpkgRepository_Kind             = "LocalOpkgRepository"
	LocalOpkgRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalOpkgRepository_Kind}.String()
	LocalOpkgRepository_KindAPIVersion   = LocalOpkgRepository_Kind + "." + CRDGroupVersion.String()
	LocalOpkgRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalOpkgRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalOpkgRepository{}, &LocalOpkgRepositoryList{})
}
