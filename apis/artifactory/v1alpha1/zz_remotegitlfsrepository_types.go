...
type RemoteGitLFSRepositoryContentSynchronisationInitParameters struct {
...
type RemoteGitLFSRepositoryContentSynchronisationObservation struct {
...
type RemoteGitLFSRepositoryContentSynchronisationParameters struct {
...
type RemoteGitLFSRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteGitLFSRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteGitLFSRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteGitLFSRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteGitLFSRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteGitLFSRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteGitLFSRepositorySpec defines the desired state of RemoteGitLFSRepository
type RemoteGitLFSRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteGitLFSRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteGitLFSRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteGitLFSRepositoryStatus defines the observed state of RemoteGitLFSRepository.
type RemoteGitLFSRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteGitLFSRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteGitLFSRepository is the Schema for the RemoteGitLFSRepositorys API. <no value>
...
type RemoteGitLFSRepository struct {
	...
	Spec   RemoteGitLFSRepositorySpec   `json:"spec"`
	Status RemoteGitLFSRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteGitLFSRepositoryList contains a list of RemoteGitLFSRepositorys
type RemoteGitLFSRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteGitLFSRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteGitLFSRepository_Kind             = "RemoteGitLFSRepository"
	RemoteGitLFSRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteGitLFSRepository_Kind}.String()
	RemoteGitLFSRepository_KindAPIVersion   = RemoteGitLFSRepository_Kind + "." + CRDGroupVersion.String()
	RemoteGitLFSRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteGitLFSRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteGitLFSRepository{}, &RemoteGitLFSRepositoryList{})
}
