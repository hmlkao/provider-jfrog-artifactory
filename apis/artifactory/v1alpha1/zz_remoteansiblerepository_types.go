...
type RemoteAnsibleRepositoryContentSynchronisationInitParameters struct {
...
type RemoteAnsibleRepositoryContentSynchronisationObservation struct {
...
type RemoteAnsibleRepositoryContentSynchronisationParameters struct {
...
type RemoteAnsibleRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteAnsibleRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteAnsibleRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteAnsibleRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteAnsibleRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteAnsibleRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteAnsibleRepositorySpec defines the desired state of RemoteAnsibleRepository
type RemoteAnsibleRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteAnsibleRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteAnsibleRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteAnsibleRepositoryStatus defines the observed state of RemoteAnsibleRepository.
type RemoteAnsibleRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteAnsibleRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteAnsibleRepository is the Schema for the RemoteAnsibleRepositorys API. <no value>
...
type RemoteAnsibleRepository struct {
	...
	Spec              RemoteAnsibleRepositorySpec   `json:"spec"`
	Status            RemoteAnsibleRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteAnsibleRepositoryList contains a list of RemoteAnsibleRepositorys
type RemoteAnsibleRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteAnsibleRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteAnsibleRepository_Kind             = "RemoteAnsibleRepository"
	RemoteAnsibleRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteAnsibleRepository_Kind}.String()
	RemoteAnsibleRepository_KindAPIVersion   = RemoteAnsibleRepository_Kind + "." + CRDGroupVersion.String()
	RemoteAnsibleRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteAnsibleRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteAnsibleRepository{}, &RemoteAnsibleRepositoryList{})
}
