...
type LocalHuggingfacemlRepositoryInitParameters struct {
...
type LocalHuggingfacemlRepositoryObservation struct {
...
type LocalHuggingfacemlRepositoryParameters struct {
...
// LocalHuggingfacemlRepositorySpec defines the desired state of LocalHuggingfacemlRepository
type LocalHuggingfacemlRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalHuggingfacemlRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalHuggingfacemlRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalHuggingfacemlRepositoryStatus defines the observed state of LocalHuggingfacemlRepository.
type LocalHuggingfacemlRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalHuggingfacemlRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalHuggingfacemlRepository is the Schema for the LocalHuggingfacemlRepositorys API. <no value>
...
type LocalHuggingfacemlRepository struct {
	...
	Spec              LocalHuggingfacemlRepositorySpec   `json:"spec"`
	Status            LocalHuggingfacemlRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalHuggingfacemlRepositoryList contains a list of LocalHuggingfacemlRepositorys
type LocalHuggingfacemlRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalHuggingfacemlRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalHuggingfacemlRepository_Kind             = "LocalHuggingfacemlRepository"
	LocalHuggingfacemlRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalHuggingfacemlRepository_Kind}.String()
	LocalHuggingfacemlRepository_KindAPIVersion   = LocalHuggingfacemlRepository_Kind + "." + CRDGroupVersion.String()
	LocalHuggingfacemlRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalHuggingfacemlRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalHuggingfacemlRepository{}, &LocalHuggingfacemlRepositoryList{})
}
