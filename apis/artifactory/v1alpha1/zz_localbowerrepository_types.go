...
type LocalBowerRepositoryInitParameters struct {
...
type LocalBowerRepositoryObservation struct {
...
type LocalBowerRepositoryParameters struct {
...
// LocalBowerRepositorySpec defines the desired state of LocalBowerRepository
type LocalBowerRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalBowerRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalBowerRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalBowerRepositoryStatus defines the observed state of LocalBowerRepository.
type LocalBowerRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalBowerRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalBowerRepository is the Schema for the LocalBowerRepositorys API. <no value>
...
type LocalBowerRepository struct {
	...
	Spec              LocalBowerRepositorySpec   `json:"spec"`
	Status            LocalBowerRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalBowerRepositoryList contains a list of LocalBowerRepositorys
type LocalBowerRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalBowerRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalBowerRepository_Kind             = "LocalBowerRepository"
	LocalBowerRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalBowerRepository_Kind}.String()
	LocalBowerRepository_KindAPIVersion   = LocalBowerRepository_Kind + "." + CRDGroupVersion.String()
	LocalBowerRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalBowerRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalBowerRepository{}, &LocalBowerRepositoryList{})
}
