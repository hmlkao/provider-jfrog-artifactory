...
type RemotePubRepositoryContentSynchronisationInitParameters struct {
...
type RemotePubRepositoryContentSynchronisationObservation struct {
...
type RemotePubRepositoryContentSynchronisationParameters struct {
...
type RemotePubRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemotePubRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemotePubRepositoryObservation struct {
	...
	ContentSynchronisation []RemotePubRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemotePubRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemotePubRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemotePubRepositorySpec defines the desired state of RemotePubRepository
type RemotePubRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemotePubRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemotePubRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemotePubRepositoryStatus defines the observed state of RemotePubRepository.
type RemotePubRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemotePubRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemotePubRepository is the Schema for the RemotePubRepositorys API. <no value>
...
type RemotePubRepository struct {
	...
	Spec   RemotePubRepositorySpec   `json:"spec"`
	Status RemotePubRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemotePubRepositoryList contains a list of RemotePubRepositorys
type RemotePubRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemotePubRepository `json:"items"`
}

// Repository type metadata.
var (
	RemotePubRepository_Kind             = "RemotePubRepository"
	RemotePubRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemotePubRepository_Kind}.String()
	RemotePubRepository_KindAPIVersion   = RemotePubRepository_Kind + "." + CRDGroupVersion.String()
	RemotePubRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemotePubRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemotePubRepository{}, &RemotePubRepositoryList{})
}
