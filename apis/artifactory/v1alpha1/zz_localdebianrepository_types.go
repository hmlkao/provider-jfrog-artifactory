...
type LocalDebianRepositoryInitParameters struct {
	...
	DdebSupported *bool `json:"ddebSupported,omitempty" tf:"ddeb_supported,omitempty"`
...
type LocalDebianRepositoryObservation struct {
...
type LocalDebianRepositoryParameters struct {
...
// LocalDebianRepositorySpec defines the desired state of LocalDebianRepository
type LocalDebianRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalDebianRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalDebianRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalDebianRepositoryStatus defines the observed state of LocalDebianRepository.
type LocalDebianRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalDebianRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalDebianRepository is the Schema for the LocalDebianRepositorys API. <no value>
...
type LocalDebianRepository struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              LocalDebianRepositorySpec   `json:"spec"`
	Status            LocalDebianRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalDebianRepositoryList contains a list of LocalDebianRepositorys
type LocalDebianRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalDebianRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalDebianRepository_Kind             = "LocalDebianRepository"
	LocalDebianRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalDebianRepository_Kind}.String()
	LocalDebianRepository_KindAPIVersion   = LocalDebianRepository_Kind + "." + CRDGroupVersion.String()
	LocalDebianRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalDebianRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalDebianRepository{}, &LocalDebianRepositoryList{})
}
