...
type LocalSwiftRepositoryInitParameters struct {
...
type LocalSwiftRepositoryObservation struct {
...
type LocalSwiftRepositoryParameters struct {
...
// LocalSwiftRepositorySpec defines the desired state of LocalSwiftRepository
type LocalSwiftRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalSwiftRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalSwiftRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalSwiftRepositoryStatus defines the observed state of LocalSwiftRepository.
type LocalSwiftRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalSwiftRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalSwiftRepository is the Schema for the LocalSwiftRepositorys API. <no value>
...
type LocalSwiftRepository struct {
	...
	Spec              LocalSwiftRepositorySpec   `json:"spec"`
	Status            LocalSwiftRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalSwiftRepositoryList contains a list of LocalSwiftRepositorys
type LocalSwiftRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalSwiftRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalSwiftRepository_Kind             = "LocalSwiftRepository"
	LocalSwiftRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalSwiftRepository_Kind}.String()
	LocalSwiftRepository_KindAPIVersion   = LocalSwiftRepository_Kind + "." + CRDGroupVersion.String()
	LocalSwiftRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalSwiftRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalSwiftRepository{}, &LocalSwiftRepositoryList{})
}
