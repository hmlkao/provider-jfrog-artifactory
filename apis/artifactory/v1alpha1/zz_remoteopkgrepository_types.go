...
type RemoteOpkgRepositoryContentSynchronisationInitParameters struct {
...
type RemoteOpkgRepositoryContentSynchronisationObservation struct {
...
type RemoteOpkgRepositoryContentSynchronisationParameters struct {
...
type RemoteOpkgRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteOpkgRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteOpkgRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteOpkgRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteOpkgRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteOpkgRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteOpkgRepositorySpec defines the desired state of RemoteOpkgRepository
type RemoteOpkgRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteOpkgRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteOpkgRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteOpkgRepositoryStatus defines the observed state of RemoteOpkgRepository.
type RemoteOpkgRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteOpkgRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteOpkgRepository is the Schema for the RemoteOpkgRepositorys API. <no value>
...
type RemoteOpkgRepository struct {
	...
	Spec   RemoteOpkgRepositorySpec   `json:"spec"`
	Status RemoteOpkgRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteOpkgRepositoryList contains a list of RemoteOpkgRepositorys
type RemoteOpkgRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteOpkgRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteOpkgRepository_Kind             = "RemoteOpkgRepository"
	RemoteOpkgRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteOpkgRepository_Kind}.String()
	RemoteOpkgRepository_KindAPIVersion   = RemoteOpkgRepository_Kind + "." + CRDGroupVersion.String()
	RemoteOpkgRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteOpkgRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteOpkgRepository{}, &RemoteOpkgRepositoryList{})
}
