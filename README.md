...
Provider is generated from Terraform provider [jfrog/artifactory v12.9.6](https://registry.terraform.io/providers/jfrog/artifactory/12.9.6/docs).
...
```bash
up ctp provider install hmlkao/provider-jfrog-artifactory:v0.5.0
```
...
spec:
  package: hmlkao/provider-jfrog-artifactory:v0.5.0
EOF
```
...
List of all resources of [Terraform provider v12.9.6](https://registry.terraform.io/providers/jfrog/artifactory/12.9.6/docs).
