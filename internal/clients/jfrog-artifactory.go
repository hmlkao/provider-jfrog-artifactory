...
var optFields = []string{"url", "access_token", "tfc_credential_tag_name"}
...
func TerraformSetupBuilder(version, providerSource, providerVersion string) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		// if configRef == nil {
		// 	return tfmProviderSetup, errors.New(errNoProviderConfig)
		// }

		// t := resource.NewProviderConfigUsageTracker(client, &namespacedv1beta1.ProviderConfigUsage{})
		// if err := t.Track(ctx, mg); err != nil {
		// 	return tfmProviderSetup, errors.Wrap(err, errTrackUsage)
		// }
